...
public class Utilisateur implements Serializable{
	...
	public Utilisateur(String pseudo, String nom, String prenom, String email, String telephone, String rue,
			String codePostal, String ville, String motDePasse, int credit, float administrateur,
			List<ArticlesVendu> listeArticle, List<Enchere> listeEnchere) {
		super();
		this.pseudo = pseudo;
		this.nom = nom;
		this.prenom = prenom;
	...
	public Utilisateur(int noUtilisateur,String pseudo, String nom, String prenom, String email, String telephone, String rue,
			String codePostal, String ville, String motDePasse, int credit, float administrateur,
			List<ArticlesVendu> listeArticle, List<Enchere> listeEnchere) {
		this(pseudo, nom, prenom, email, telephone, rue, codePostal, ville, motDePasse, credit,administrateur, listeArticle,listeEnchere);
	...
	public float getAdministrateur() {
		return administrateur;
	}

	public void setAdministrateur(float administrateur) {
		this.administrateur = administrateur;
	}
	...
	public String toString() {
		return "Utilisateur [noUtilisateur=" + noUtilisateur + ", pseudo=" + pseudo + ", nom=" + nom + ", prenom="
				...
				+ ", administrateur=" + administrateur + ", listeArticle=" + listeArticle + ", listeEnchere="
				+ listeEnchere + "]";
	}
